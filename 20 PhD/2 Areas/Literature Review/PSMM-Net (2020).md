---
aliases: [psmm_net_fas]
tags: [paper, pad, deep-fas-survey, multimodal]
authors: Ajian Liu, Zichang Tan, Jun Wan, Sergio Escalera, Guodong Guo, Stan Z. Li
year: 2021
venue: WACV
paper_url: https://openaccess.thecvf.com/content/WACV2021/html/Liu_CASIA-SURF_CeFA_A_Benchmark_for_Multi-Modal_Cross-Ethnicity_Face_Anti-Spoofing_WACV_2021_paper.html
code_url: 
status: "📚 To Read"
...
- **Backbone:** ResNet18
- **Loss:** Binary CE loss for each stream
- **Input:** RGB, Depth, NIR
